                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" id="editor" name="desc" type="text" placeholder="Enter Brand Name"  @if(old('desc')) value="{{ old('desc') }}" @endif  id="example-text-input"></textarea>
