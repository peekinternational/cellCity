                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td>
                                                          <span class="bfh-flag-{{$carrier->country_class}}"></span> {{$carrier->country}}
                                                        ...
                                                        <td>
                                                            <ul class="list-inline font-size-20 contact-links mb-0">
                                                                <li class="list-inline-item px-2">
                                                                    <a href="{{url('admin/icarriers/'.$carrier->id.'/edit') }}" data-toggle="tooltip" data-placement="top" title="Edit"><i class="mdi mdi-account-edit-outline"></i></a>
                                                                </li>
                                                                <li class="list-inline-item px-2">
                                                                   <form action="{{url('admin/icarriers/'.$carrier->id)}}" method="post">
                                                                    {{csrf_field()}}
                                                                       @method('DELETE')
