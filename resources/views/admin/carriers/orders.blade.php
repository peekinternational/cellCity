                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover" id="example"  >
                                                ...
                                                <tbody>
                                               @foreach(CityClass::orderWire() as $index => $carrier)
                                                     @php
                                                  ...
                                                  @endphp
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <img src="{{asset(CityClass::orderWireCar($carrier->carrier_id)->image)}}" width="80px" height="80px" alt="carrier Image">

                                                        </td>
                                                        <td>
                                                           {{CityClass::orderWireCar($carrier->carrier_id)->name}}
