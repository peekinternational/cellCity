          ...
          <div class="select-address-content-wrapper">
            <div class="form-group">
              <div class="new-input-comp">
                <div>
                  <input placeholder="Your First Name" form="repairType" type="text" name="first_name" id="first_name" class="form-control" @if(Auth::guard('web')->check()) value="{{Auth::guard('web')->user()->first_name}}" @else value="" @endif required>
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="new-input-comp">
                <div>
                  <input placeholder="Your Last Name" form="repairType" type="text" name="last_name" id="last_name" class="form-control" @if(Auth::guard('web')->check()) value="{{Auth::guard('web')->user()->last_name}}" @else value="" @endif required>
                </div>
              </div>
            </div>
            <div class="form-group">
