    ...
    <div role="tabpanel" class="tab-pane active" id="home">
      ...
      <div id="wireless-details">
          ...
          <div class="col-md-3">
            <form id="billpayment" action="{{url('billPay')}}" method="post">
               ...
               <div style="margin-bottom: 20px;">
                 International phone:
                 @foreach(explode(",", $getSingleData->phone_codes) as $phone_code)
                 <p style="margin-bottom: 0">{{$phone_code}}</p>
                 @endforeach
               </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
          <h3><a href="{{url('international-refill/plans/'.$getSingleData->id)}}"> < Back</a></h3>
        </div>
      </div>
    </div>
