            ...
            <div class="col-lg-6 col-xl-6 col-sm-12">
              <form action="" id="" method="post">
                ...
                <div class="row ml-1 shipping_address_slot">
                  ...
                  <div class="col-lg-12">
                    <p class="single-form-row">
                      ...
                      <span class="input-group-addon">us +1</span>
                        <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ $address->mobileNo ?? '' }}" required>
                  ...
                  <div class="col-lg-12">
                    <p class="single-form-row">
                      <input type="text" class="form-control" name="shipping_address2" placeholder="Apartment, suite, unit etc. (optional)" required>
                    </p>
                  </div>
                  <div class="col-lg-12">
                    <p class="single-form-row">
