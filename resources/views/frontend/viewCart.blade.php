                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label>Phone Number</label>
                                            ...
                                            <input type="text" class="form-control" name="mobileNo" aria-label="Amount (to the nearest dollar)" placeholder="Phone Number" Min="10" Max="11" @if(Auth::guard('web')->check()) value="{{Auth::guard('web')->user()->phoneno}}" @else value="" @endif required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="country"  placeholder="Country"  @if(Auth::guard('web')->check()) value="{{Auth::guard('web')->user()->country}}" @else value="United States" @endif
                                                    class="form-control" value="United States" readonly>
                                            </div>
                                            <div class="col-md-6">
                                                <label>State</label>
                                                <select name="state" required class="form-control" onchange="getCities(this)"
                                                    >
